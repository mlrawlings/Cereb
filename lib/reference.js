...
export default class Reference {
	constructor(manager, path, current, previous) {
		...
		if(this.constructor == Reference) {
			TypeReference = Reference.Types.get(current.constructor)
			if(!TypeReference) {
...
Reference.Types = new Immutable.Map([
	  [Immutable.Map, MapReference]
	, [Immutable.List, ListReference]
	, [Number, NumberReference]
	, [String, StringReference]
	, [Boolean, BooleanReference]
])